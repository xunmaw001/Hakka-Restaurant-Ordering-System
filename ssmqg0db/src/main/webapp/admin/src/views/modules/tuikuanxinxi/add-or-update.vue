<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="退款进度" prop="tuikuanjindu">
          <el-select v-model="ruleForm.tuikuanjindu" placeholder="请选择退款进度">
            <el-option
                v-for="(item,index) in tuikuanjinduOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="退款进度" prop="tuikuanjindu">
	      <el-input v-model="ruleForm.tuikuanjindu"
                placeholder="退款进度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
